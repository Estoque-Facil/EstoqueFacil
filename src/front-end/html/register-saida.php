<?php
    ...
    $tipoSaidaOptions = getSelectOptions("SELECT TipoSaidaId AS id, TipoSaidaNome AS nome FROM TbTipoSaida WHERE TipoSaidaNome <> 'Fabricação'");
...
<head>
    ...
    <script src="../js/register-saida.js" defer></script>
...
<body>
    ...
    <main>
        <div class="container my-5">
            <h1 class="text-left mb-4">Registrar Saída</h1>
            <form action="../../back-end/processar-register-saida.php?tipo=S" method="post" id="form-register-saida">
                <div class="form-row">
                    <div class="form-group">
                        <label for="tipo-saida" class="form-label">Tipo de operação</label>
                        <select class="form-select" role="button" id="tipo-saida" name="tipo-saida" required>
                        <option value="" disabled selected>Selecione o Tipo de operação</option>
                            <?php echo $tipoSaidaOptions; ?>
                        </select>
                ...
                <div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <select class="form-select" role="button" id="produto" name="produto" required onchange="verificarComponente()">
                ...
                <div id="componentes">
                    ...
                    <div class="form-row" id="comp-inputs">
                    </div>
                </div>
    ...
    <?php
        if (isset($_GET['status']) && $_GET['status'] === 'falha') {
            echo '<div class="register-falha" id="register-falha">
                    <p>Erro ao registrar saída, tente novamente!</p>
                  </div>';
